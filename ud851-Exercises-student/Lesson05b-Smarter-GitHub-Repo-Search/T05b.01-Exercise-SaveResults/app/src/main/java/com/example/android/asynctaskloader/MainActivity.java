...
public class MainActivity extends AppCompatActivity {
    ...
    static final String queryURL = "www.naver.com";
    // TODO (2) Create a static final key to store the search's raw JSON
    static final String rawJSON = "www.naver.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            savedInstanceState.putString(queryURL,mUrlDisplayTextView.getText().toString());
            triggerSearch(queryURL,savedInstanceState);
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        String JSONcontent = mSearchResultsTextView.getText().toString();
        outState.putString(rawJSON,JSONcontent);
