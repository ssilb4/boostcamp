...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler implements LoasderCallbacks{
    ...
    Class<String> onCreateLoader() {
        return new AsyncTaskLoader<String> s;
